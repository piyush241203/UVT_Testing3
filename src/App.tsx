    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <h2 style={{ margin: 0, background: 'linear-gradient(135deg, #a78bfa, #34d399)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontWeight: '800', letterSpacing: '-0.5px', fontSize: '20px' }}>🚀 UVT React Demo v5.1 — Certified ✨</h2>
          <span style={{ padding: '4px 12px', borderRadius: '20px', background: 'linear-gradient(135deg, #10b981, #059669)', color: '#ffffff', fontSize: '12px', fontWeight: 'bold', boxShadow: '0 2px 8px rgba(16,185,129,0.4)' }}>Certified v5.1</span>
